...
mem_init(void)
{
	...
	//struct PageInfo * kstk; 
	//for(i=0,n=KSTACKTOP-KSTKSIZE;i<KSTKSIZE/PGSIZE;i++)
	//{	
	//	kstk = pa2page(PADDR(bootstack))+i;
	//	page_insert(kern_pgdir,kstk,(void *)n,PTE_W); n+=PGSIZE;
	//}
...
page_free(struct PageInfo *pp)
{
	...
	//for(prev=NULL,curr=page_free_list;curr;prev=curr,curr=curr->pp_link)
...
//	if(!(pt & PTE_P)) 
//	{		
//			pp = page_alloc(1);	//allocate and initialize to 0
...
//<0 there is no free memory, so we can't allocate a page table
//
