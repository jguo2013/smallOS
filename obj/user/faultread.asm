	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024b:	0f be 80 e8 12 80 00 	movsbl 0x8012e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032f:	ff 24 8d 20 14 80 00 	jmp    *0x801420(,%ecx,4)
  ...
  800417:	c7 44 24 08 02 13 80 	movl   $0x801302,0x8(%esp)
  80041e:	00 
  ...
  80044c:	b8 05 13 80 00       	mov    $0x801305,%eax
...
sys_net_receive(uint32_t * buf, uint32_t *size)
{
  ...
  800bcb:	00 
  800bcc:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800bd3:	00 
  800bd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bdb:	00 
  800bdc:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_net_send(void *buf, uint32_t size)
{
  ...
  800c29:	00 
  800c2a:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800c31:	00 
  800c32:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c39:	00 
  800c3a:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800c86:	00 
  800c87:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800c8e:	00 
  800c8f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c96:	00 
  800c97:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d1c:	00 
  800d1d:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800d24:	00 
  800d25:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2c:	00 
  800d2d:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d7a:	00 
  800d7b:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800d82:	00 
  800d83:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8a:	00 
  800d8b:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dd8:	00 
  800dd9:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800de0:	00 
  800de1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de8:	00 
  800de9:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e36:	00 
  800e37:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800e3e:	00 
  800e3f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e46:	00 
  800e47:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e94:	00 
  800e95:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800e9c:	00 
  800e9d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea4:	00 
  800ea5:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ef3:	00 
  800ef4:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800efb:	00 
  800efc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f03:	00 
  800f04:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800fb8:	00 
  800fb9:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  800fc0:	00 
  800fc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fc8:	00 
  800fc9:	c7 04 24 04 16 80 00 	movl   $0x801604,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801010:	c7 04 24 14 16 80 00 	movl   $0x801614,(%esp)
  ...
  801026:	e8 8d f0 ff ff       	call   8000b8 <vcprintf>
	cprintf("\n");
  80102b:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
